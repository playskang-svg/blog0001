...
3. 가고시마항에서 야쿠시마 가는 법: 이른 배를 위한 전날 숙소 — 발행 완료 (`draft: false`, `kagoshima-port-to-yakushima-stay.mdx`)
4. 모지코와 시모노세키 배 이동: 고쿠라·모지코 숙박 비교 — 발행 완료 (`draft: false`, `mojiko-shimonoseki-ferry-stay.mdx`)
